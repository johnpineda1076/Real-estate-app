...
const Footer = () => {
  ...
  const propertyTypes = [
    ...
    { name: 'Townhouses', path: '/properties?type=Townhouse' },
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-1">
            <Link to="/" className="inline-flex items-center gap-2">
              ...
              <h3 className="text-2xl font-bold text-white">RealEstate</h3>
            </Link>
            <p className="text-white/70 text-sm leading-relaxed mt-4 mb-6">
              Your trusted partner in finding the perfect property. We connect buyers with their dream homes through personalized service and expert market knowledge.
            </p>
            {/* Social Links */}
            <div className="flex items-center gap-3">
              {socialLinks.map((social) => (
                <a
                  key={social.name}
                  href={social.href}
                  className="w-10 h-10 rounded-full bg-white/10 hover:bg-accent
            ...
            <ul className="space-y-3">
              {quickLinks.map((link) => (
                <li key={link.name}>
                  <Link
                    to={link.path}
                    className="text-white/70 hover:text-accent text-sm transition-colors duration-300
                             inline-flex items-center gap-2 group"
                  >
                    <span className="w-1.5 h-1.5 rounded-full bg-white/40 group-hover:bg-accent transition-colors" />
                    {link.name}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-3 mb-6">
              <li className="flex items-start gap-3 text-sm text-white/70">
                ...
                <span>123 Real Estate Ave, Suite 100<br />Bogotá, Colombia</span>
              </li>
            ...
            {subscribed && (
              <p className="text-accent text-xs mt-2 animate-fade-in">
